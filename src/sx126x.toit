...
class Sx1262 implements radio.Radio:
  ...
  */
  ...
  write-buffer_ offset/int data/ByteArray -> none:
    command := ByteArray (data.size + 1)
    command[0] = offset
    command.replace 1 data
